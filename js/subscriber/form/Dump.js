 ...
 * @extends Subscriber
 */
Viskit.s.form.Dump = function() {
    Viskit.s.Subscriber.call(this);
};

Viskit.extend(Viskit.s.form.Dump, Viskit.s.Subscriber);

Viskit.s.form.Dump.prototype.property("canvas");

Viskit.s.form.Dump.prototype.create = function() {
...
Viskit.s.form.Dump.prototype.pushData = function(data) {
...
Viskit.s.form.Dump.prototype.load = function() {
    var canvas = document.getElementById(this.canvas());
    canvas.innerHTML = "data comes here!";
};

Viskit.s.form.Dump.prototype.unload = function() {
    var canvas = document.getElementById(this.canvas());
    canvas.innerHTML = "";
};
