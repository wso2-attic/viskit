...
//Constructor
Viskit.s.chart.protovis.BarChart2 = function(canvas, chartTitle, chartDesc) {
...
Viskit.extend(Viskit.s.chart.protovis.BarChart2, Viskit.s.chart.Chart);

Viskit.s.chart.protovis.BarChart2.prototype
    .property("dataField")
    .property("dataValue")
    .property("dataLabel")
    .property("ySuffix")
...
Viskit.s.chart.protovis.BarChart2.prototype.load = function (w, h) {
    if ( w !== undefined ) {
        this.width(w);
    }
    if ( h !== undefined ) {
...
* @private
*/
Viskit.s.chart.protovis.BarChart2.prototype.titleSpacing = function () {
    if(this.title() === "") {
        return 1;
    }
    else {
...
* @private
*/
Viskit.s.chart.protovis.BarChart2.prototype.populateData = function (thisObject) {
    var mt = 25;
	var mr = 10;
	var ml = 100;
	var mb = 7;
...
Viskit.s.chart.protovis.BarChart2.prototype.getData = function (thisObject) {
    return thisObject.formattedData;
};

Viskit.s.chart.protovis.BarChart2.prototype.update = function () {
...
Viskit.s.chart.protovis.BarChart2.prototype.getDataLabel = function (i) {
    if (this.data !== null){
