 ...
 * PropertyGrid 
 */
Viskit.ide.PropertyGrid = function(canvas) {
    this.attr = [];
    id = 1; //TODO
    this.getID = function() {
        return id;
...
Viskit.ide.PropertyGrid.prototype.property = function(name) {
    /*
    * Define the setter-getter globally
    */
    Viskit.ide.PropertyGrid.prototype[name] = function(v) {
      if (arguments.length) {
        this.attr[name] = v;
        return this;
      }
...
Viskit.ide.PropertyGrid.prototype
    .property("title")
    .property("divEl")
    .property("width")
    .property("height");
    
Viskit.ide.PropertyGrid.prototype.load = function (uwElement) {
    this.clean();
...
Viskit.ide.PropertyGrid.prototype.update = function (uwElement) {
    this.clean();
    this.uwElement = uwElement;
    var propObj = uwElement.propertyObject;
    var elem = uwElement.elem;
...
Viskit.ide.PropertyGrid.prototype.updateProperty = function (propname, value) {
...
Viskit.ide.PropertyGrid.prototype.clean = function () {
    document.getElementById(this.divEl()).innerHTML = "<table id='property_table'><tbody></tbody></table>";
};

Viskit.ide.PropertyGrid.prototype.field_int = function (lbl, val, fname) {
...
Viskit.ide.PropertyGrid.prototype.field_string = function (lbl, val, fname) {
    var html = "<input type='text' value='"+val+"' onChange='propGrid.updateProperty(\""+fname+"\", this.value)'/>";
    this.addTableRow('property_table', lbl, html);
};

Viskit.ide.PropertyGrid.prototype.field_array = function (lbl, val, fname) {
    var html = "<input type='text' value='"+val+"' onChange='propGrid.updateProperty(\""+fname+"\", this.value.split(\",\"))'/>";
    this.addTableRow('property_table', lbl, html);
};

Viskit.ide.PropertyGrid.prototype.field_enum = function (lbl, enums) {
    var html = "<select>";
...
Viskit.ide.PropertyGrid.prototype.field_boolean = function (lbl, val, fname) {
...
Viskit.ide.PropertyGrid.prototype.addTableRow = function (tablename, label, content) {
    var td1 = "<td>"+label+"</td>";
