Viskit.ide.uwElement = function (r, uElement, width, height, provider, consProp, name, propObj, type) {
	this.x = 0;
	this.y = 0;
	this.width = width;
	this.height = height;
...
Viskit.ide.uwElement.prototype.updateHotspots = function (ind) {
	if (ind != 0)
...
Viskit.ide.uwElement.prototype.updateDimentions = function (that){
...
Viskit.ide.uwElement.prototype.updateUwElementDimentions = function (){
...
Viskit.ide.uwElement.prototype.redraw = function (x, y) {
	this.x = x;
	this.y = y;
...
Viskit.ide.uwElement.prototype.pushData = function (d) {
...
Viskit.ide.uwElement.prototype.select = function () {
    this.selected = true;
    this.provider.pullDataSync();
};

Viskit.ide.uwElement.prototype.deselect = function () {
    this.selected = false;
    this.provider.pullDataSync();
};
